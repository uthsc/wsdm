<?php
$pagename ='Registration &amp; Meeting Agenda';
            ...
            <h1><?php echo $pagename;?></h1>
                <div class="row">
                    <div class="small-12 large-7 columns">
                        <div class="row alert-box warning" style="margin: 0 .25rem;">
                            <div class="columns small-centered">
                                <div class="columns medium-3 hide-for-small text-right">
                                    <span class="fa fa-calendar fa-4x text-right"></span>
                                </div>
                        ...
                        <br style="clear: both;" />
                        <p>We encourage you to register early and take advantage of the discounted fee. General registration includes all courses, CE credits, exhibits, lunch on Friday and Saturday, breaks each day and Welcome Party. <strong>REGISTRATION DEADLINE: February 11, 2018</strong>. Advance registration for all programs is strongly encouraged and appreciated. Check-in for the William F. Slagle Dental Meeting begins Thursday afternoon at the Hilton Hotel and will continue all day Friday and Saturday until 5:00 p.m. All information, nametags, and meal tickets will be held for pick-up at the registration desk. Your registration fee covers your choice of sessions unless otherwise noted, Friday and Saturday lunch, refreshment breaks, continuing education credit, and admission to the Welcome Party and exhibit booths.</p>
						<div class="row">
                            <div class="columns small-1">
                                <i class="fa fa-cutlery fa-3x"></i>
                            </div>
                            <div class="columns small-11">
                                <p><strong> If you plan to eat lunch onsite, please remember to register for your lunch ticket (included with the registration fee)!</strong></p>
                            </div>
                        </div>
