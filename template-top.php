...
<div class="row gutter">
				...
				<div class="contain-to-grid sticky">
    				<nav class="top-bar" data-topbar role="navigation">
    				    <ul class="title-area">
    				        <li class="name"><!-- <h1><a href="#">My Site</a></h1>--> </li> <!-- Remove the class "menu-icon" to get rid of menu icon. Take out "Menu" to just have icon alone -->
    				        ...
    				        <ul class="left">
    				            ...
    				            <li class="has-dropdown"> <a href="#">Attend</a>
    				                <ul class="dropdown">
			    				            ...
			    				            <li><a href="http://www.uthscalumni.com/DentistryWeekend2015">Alumni Events &amp; Reunion Info <i class="fa fa-external-link"></i></a></li>
    				                </ul>
    				            </li>
